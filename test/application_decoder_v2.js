...
var latitude=(22.123456+90)*1e06;
var longitude=(114.123456+180)*1e06;
var battery=1.95*100;
var original_msg="20200623;19193;112123456;294123456;195";
console.log(date+" "+time+" "+latitude+" "+longitude+" "+battery);
console.log(original_msg.length);
...
var hex_data=hex_date+";"+hex_time+";"+hex_latitude+";"+hex_longitude+";"+hex_battery;
console.log(hex_date+" "+hex_time+" "+hex_latitude+" "+hex_longitude+" "+hex_battery);
